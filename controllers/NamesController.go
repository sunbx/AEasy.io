...
func (c *NamesUpdateController) Get() {
	signingKey := c.GetString("signingKey")
	...
	receipt, e := models.UpdateAENS(aeasyAccount, chain)
	if e != nil {
		c.ErrorJson(-500, "parameter is nul", JsonData{})
	}
...
func (c *NamesInfoController) Get() {
...
func (c *NamesTransferController) Get() {
	name := c.GetString("name")
	signingKey := c.GetString("signingKey")
